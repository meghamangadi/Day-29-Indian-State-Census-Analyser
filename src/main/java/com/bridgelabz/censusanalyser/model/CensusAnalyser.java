...
public class CensusAnalyser {
	...
	public int loadIndiaCensusData(String csvFilePath) throws CensusAnalyserException {
		try {
			...
			throw new CensusAnalyserException("CSV File Must Have Comma As Delimiter",
					CensusAnalyserException.ExceptionType.CENSUS_WRONG_DELIMITER);
		} catch (IOException e) {
			throw new CensusAnalyserException(e.getMessage(),
					CensusAnalyserException.ExceptionType.CENSUS_FILE_INCORRECT);
		}
	}
